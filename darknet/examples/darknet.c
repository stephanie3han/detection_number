...
//extern void test_detector(char *datacfg, char *cfgfile, char *weightfile, char *filename, float thresh, float hier_thresh, char *outfile, int fullscreen);  //1

extern void test_detector(char *datacfg, char *cfgfile, char *weightfile, char *filename, float thresh, float hier_thresh, char *outfile, int fullscreen, char *idir, char *odir);  ////0
...
int main(int argc, char **argv)
{
    ...
    if (0 == strcmp(argv[1], "average")){
        ...
        //char *filename = (argc > 4) ? argv[4]: 0;   //1
        ...
        //test_detector("cfg/coco.data", argv[2], argv[3], filename, thresh, .5, outfile, fullscreen); //1

        test_detector("cfg/coco.data", argv[2], argv[3], filename, thresh, .5, outfile,fullscreen,idir,odir);  ////0
